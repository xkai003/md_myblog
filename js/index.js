...
// 按钮的内容
const toggleBtnspan = document.getElementById('themeToggleBtnspan');
// headstatus
...
function setNightMode() {
    ...
    localStorage.setItem('themeMode', 'night'); // 保存到本地存储
    headstatus.style.backgroundColor = "black";
    document.querySelector('#themeToggleBtnspan').innerHTML = 
    `<svg t="1769682517627" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8918" width="30" height="30"><path d="M837.12 815.104c61.44-61.44 101.376-135.68 119.808-214.016 5.12-22.528-22.016-37.888-38.4-21.504l-0.512 0.512c-136.192 136.192-358.4 133.632-491.52-7.68-125.44-133.12-123.392-340.48 3.584-472.064 1.536-1.536 3.072-3.072 4.608-5.12 16.384-16.384 1.024-43.52-21.504-38.4-77.824 18.432-151.552 57.856-212.48 118.272-178.176 176.128-179.2 461.824-2.048 638.976 176.128 177.152 461.824 177.152 638.464 1.024z" fill="#f4ea2a" p-id="8919"></path></svg>`
    console.log('当前为夜晚模式');
}
